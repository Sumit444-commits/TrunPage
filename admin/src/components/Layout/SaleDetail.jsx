...
//   const { user, service, status,reason , receipt, price, createdAt, _id, email: saleEmail } = sale;
...
//       {/* Card */}
//       <div className="max-w-5xl xl:mx-auto mx-5 bg-white rounded-xl shadow-lg p-6 mt-12  relative z-10">
//         <button
//           onClick={() => navigate(-1)}
...
//           <span className={`text-sm font-medium px-3 py-1 rounded-full ${statusMap[status]?.color}`}>
...
//             <h4 className="text-md font-semibold text-gray-800 mb-2">Sale Details</h4>
//             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
//               <p className="text-sm text-gray-600"><strong>Order Email:</strong> {saleEmail}</p>
//               <p className="text-sm text-gray-600"><strong>Sold Price:</strong> ${price}</p>
//               <p className="text-sm text-gray-600"><strong>Date:</strong> {format(new Date(createdAt), "PPpp")}</p>
...
//             <h4 className="text-md font-semibold text-gray-800 mb-2">Edit Sale Status</h4>
//             <StatusSelector
//               initialStatus={status}
//               onSave={(newStatus) => onStatusUpdate(_id, newStatus)}
//             />
//           </div>
//         </div>
//       </div>
